...
def predict_logits(model_dir, texts, max_length, batch_size, trust_remote_code, use_slow_tokenizer):
    import torch
...
def main():
    ...
    parser.add_argument("--model-dir", default="./model/bge-m3-router-fold0")
